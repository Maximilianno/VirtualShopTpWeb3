    ...
    public static class Utilitarios
    {
        ...
        public static Boolean SendMail(string dirEmail)
        {
            try
            {
                ...
                mail.Body = "Bienvenido a nuestro <b>sistema de administracion de tiendas Virtual Shop!.</b></ br>Para confirmar su registracion, debe hacer clic en el link que está a continuacion: <a>http://localhost:"+port+"/VS/Presentacion/confirmaregistro.aspx?email=" + dirEmail + "&uid=" + uid + "</a>";
